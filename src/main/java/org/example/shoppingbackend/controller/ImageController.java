...
import org.example.shoppingbackend.service.image.ImageServiceIMPL;
...
public class ImageController {
    ...
    public ResponseEntity<Resource> downloadImage(@PathVariable Long imageId) throws SQLException {
        ...
        ByteArrayResource resource = new ByteArrayResource(image.getImageBlob()
                .getBytes(1, (int) image.getImageBlob().length()));
